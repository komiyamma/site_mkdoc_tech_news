...
:run_codex
call grok --always-approve --permission-mode bypassPermissions -p "@gemini_command.mdの内容を実行して。画面には進捗以外の情報が出す必要はありません。要約に「一週間だった」とか「１日だった」などは記載しないこと。最後にこのリポジトリに対して、適切なコミットメッセージとともに全てコミット＆プッシュしてください。"
